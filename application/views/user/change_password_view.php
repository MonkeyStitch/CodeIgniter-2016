...
<div class="row">
    <div class="col-md-4">
        ...
        <form name="changepasswordForm" id="changepasswordForm" novalidate action="<?php echo base_url($this->lang_code."/user/change_password/do_change");?>" method="post">
            ...
            <button type="submit" class="btn btn-primary"><?php echo lang("user_change_password_button"); ?></button>
